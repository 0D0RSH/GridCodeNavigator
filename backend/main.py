...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173"],  # This is the default Vite dev server URL
...
async def receive_sensor_data(data: SensorData):
    ...
    return {"message": "Sensor data received", "data": latest_sensor_data}

@app.get("/sensor-data")
async def get_sensor_data():
    return {"latest_sensor_data": latest_sensor_data}
